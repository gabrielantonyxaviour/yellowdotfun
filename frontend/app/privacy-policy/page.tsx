          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p className="text-gray-700">
                ...
                including wallet addresses, transaction data, and any other
                information you choose to provide when using our platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                improve our services, to process transactions, to communicate
            ...
            <section>
              ...
              <p className="text-gray-700">
                Please note that blockchain transactions are public and
                immutable. Any information you include in a blockchain
                transaction will be publicly visible and cannot be deleted.
              </p>
            </section>
