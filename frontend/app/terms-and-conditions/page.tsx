          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p className="text-gray-700">
                By accessing and using yellow.fun, you agree to be bound by
            ...
            <section>
              ...
              <p className="text-gray-700">
                Users must not engage in market manipulation, fraud, or any
                other activities that could harm the platform or other users. We
